...
class SkuRuleGroupsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'method' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => 'manual', 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'spec_id' => ['type' => 'integer', 'length' => null, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
