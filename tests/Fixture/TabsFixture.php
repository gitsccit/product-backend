...
class TabsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'FK_tabs_plugins' => ['type' => 'index', 'columns' => ['plugin_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_tabs_plugins' => ['type' => 'foreign', 'columns' => ['plugin_id'], 'references' => ['plugins', 'id'], 'update' => 'cascade', 'delete' => 'setNull', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
