...
class TagsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'tag_category_id' => ['type' => 'integer', 'length' => null, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'FK_tags_tags' => ['type' => 'index', 'columns' => ['tag_category_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'FK_tags_tags' => ['type' => 'foreign', 'columns' => ['tag_category_id'], 'references' => ['tags', 'id'], 'update' => 'cascade', 'delete' => 'setNull', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
