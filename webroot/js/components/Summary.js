            ...
            cards.map(({image, title, description, button}) => (
              <div className="col-md-6 mb-3 mb-md-0">
                <div className="d-flex flex-column align-items-center text-center bg-white p-5 h-100">
                  ...
                  <a className="btn btn-primary py-2 px-5 mt-auto" href="#">{button}</a>
                </div>
              </div>
            ))
          }
            ...
            <th className="col-9">
              <div className="item-group justify-content-end">
                <div>
                  ...
                  <a className="text-primary text-decoration-none" href="#">Save Configuration</a>
                </div>
                <div>
                  <span className="h5 mb-0 icon-mail"></span>
                  <a className="text-primary text-decoration-none" href="#">Email Configuration</a>
                </div>
                <div>
                  <span className="h5 mb-0 icon-print"></span>
                  <a className="text-primary text-decoration-none" href="#">View Specs</a>
                </div>
              </div>
            </th>
          </tr>
