    ...
    this.props.saveConfiguration({}, result => {
      ...
      if (!configId) {
        let currentOpportunityDetail = result['opportunity']['opportunity_details'].find(opportunityDetail => (
          'opportunity_system' in opportunityDetail && opportunityDetail['opportunity_system']['system_id'] === this.state.system['id'] &&
          opportunityDetail['opportunity_system']['opportunity_system_data']['data'] === this.state.system['config_json']
        ));
      ...
      if (!subKitConfigId) {
        let subKitOpportunityDetail = result['opportunity']['opportunity_details'].find(opportunityDetail => (
          opportunityDetail['opportunity_detail_type']['name'] === 'subkit' &&
          opportunityDetail['opportunity_system']['system_id'] === item['original_id'] &&
          !selectedSubKitConfigIDs.includes(opportunityDetail['opportunity_system']['id'])
        ));
