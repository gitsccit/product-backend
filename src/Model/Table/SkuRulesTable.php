...
class SkuRulesTable extends Table
{
    ...
    {
        $validator
            ->nonNegativeInteger('sku_rule_category_id')
            ->allowEmptyString('sku_rule_category_id');
    ...
    {
        $rules->add($rules->existsIn('sku_rule_category_id', 'SkuRuleCategories'), ['errorField' => 'sku_rule_category_id']);
