...
class SkuRuleCategoriesController extends AppController
{
    ...
    {
        $skuRuleCategory = $this->SkuRuleCategories->get($id, contain: ['ParentSkuRuleCategories', 'ChildSkuRuleCategories', 'SkuRules']);
    ...
    public function add()
    {
        ...
        $parentSkuRuleCategories = $this->SkuRuleCategories->ParentSkuRuleCategories->find(limit: 200)->all()->toList();
    ...
    {
        $skuRuleCategory = $this->SkuRuleCategories->get($id, contain: []);
