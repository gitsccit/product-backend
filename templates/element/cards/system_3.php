...
<div class="d-flex flex-column bg-3 h-100 shadow">
    <a class="d-flex p-3 bg-white text-decoration-none" href="<?= $url ?>">
        <div class="d-flex flex-column align-items-center w-100 h-100">
            <div class="d-flex justify-content-between h5 font-weight-bold text-black w-100 mb-3" style="height: 38px;">
    ...
    <div class="d-flex flex-column flex-fill p-4">
        ...
        <div class="d-flex flex-column my-2">
            <?php foreach ($card['tags'] as $tag): ?>
                <div class="d-flex">
                    <div style="width:20px; height: 20px" class="d-flex justify-content-center align-items-center mr-2">
    ...
    <div class="d-flex w-100">
        <div class="d-flex flex-grow-1 justify-content-center flex-column py-1 px-3" style="background-color: black">
            ...
            <div class="font-weight-bold" style="color: #ff9900">
                <?= $this->Number->currency($card['price']) ?>
            </div>
        </div>
        <a class="d-flex align-items-center btn btn-primary font-weight-bold text-nowrap p-3"
