...
<div>
    ...
    <ul class="row nav" id="gallery-nav-bar" role="tablist" style="margin-left: -.25rem; margin-right: -.25rem">
        ...
        <?php if (count($images) > 6): ?>
            <li class="col-2 px-1 py-2">
                <a class="w-100 h-100 d-flex justify-content-center align-items-center bg-white p-1 text-black" id="see-all-images-tab" data-toggle="modal" href="#see-all-images" role="tab"
